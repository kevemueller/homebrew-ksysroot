class KsysrootRiscv64Freebsd142AT142FreebsdStable < Formula
  desc "Sysroot for riscv64-freebsd14.2@FreeBSD14.2-STABLE"
  ...
  resource "base.txz" do
    url "https://download.freebsd.org/snapshots/riscv/riscv64/14.2-STABLE/base.txz"
    version "14.2-STABLE-ksr"
    sha256 "2007220532a650c927ddbcf18b89dcd6e69e1dde0e332d1b066e7eec00aa4d20"
  end
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=14.2-STABLE FREEBSD_KERNEL=14.2 FREEBSD_MACHINE=riscv FREEBSD_MACHINE_ARCH=riscv64
    EOS
    bom << resources.map { |r|
  ...
  test do
    resource "testcases" do
      url KsysrootRiscv64Freebsd142AT142FreebsdStable.stable.url
      sha256 KsysrootRiscv64Freebsd142AT142FreebsdStable.stable.checksum.hexdigest
    end
