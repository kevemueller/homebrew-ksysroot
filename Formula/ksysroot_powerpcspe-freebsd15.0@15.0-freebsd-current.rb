class KsysrootPowerpcspeFreebsd150AT150FreebsdCurrent < Formula
  ...
  resource "base.txz" do
    ...
    sha256 "1a9066c1098b966d48b994221db45519496400131f4c37d7659e0607a6f065ff"
  end
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=15.0-CURRENT FREEBSD_MACHINE=powerpc FREEBSD_MACHINE_ARCH=powerpcspe
    EOS
    bom << resources.map { |r|
