class KsysrootPowerpc64Freebsd142AT142FreebsdStable < Formula
  ...
  resource "base.txz" do
    ...
    sha256 "e89ccccfafb5c4cf559b2a37ec338adce97e5222e3365446a241ba44335290e3"
  end
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=14.2-STABLE FREEBSD_MACHINE=powerpc FREEBSD_MACHINE_ARCH=powerpc64
    EOS
    bom << resources.map { |r|
