class KsysrootI686Freebsd133AT133FreebsdRelease < Formula
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=13.3-RELEASE FREEBSD_KERNEL=13.3 FREEBSD_MACHINE=i386 FREEBSD_MACHINE_ARCH=i386
    EOS
    bom << resources.map { |r|
    ...
    mkdir meson_cross
    meson_cross.install prefix/"cross.txt" => "i686-freebsd13.3"
    meson_cross.install_symlink meson_cross/"i686-freebsd13.3" => link_triple unless link_triple.empty?
  end
  test do
    resource "testcases" do
      url KsysrootI686Freebsd133AT133FreebsdRelease.stable.url
      sha256 KsysrootI686Freebsd133AT133FreebsdRelease.stable.checksum.hexdigest
    end
    resource("testcases").stage do
      ...
      system Formula["meson"].bin/"meson", "setup", "--native-file=ksysroot",
             "--cross-file=i686-freebsd13.3", testpath/"build"
