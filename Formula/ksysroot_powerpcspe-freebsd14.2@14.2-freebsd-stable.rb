class KsysrootPowerpcspeFreebsd142AT142FreebsdStable < Formula
  ...
  resource "base.txz" do
    ...
    sha256 "f6c85512700dfed9c8bd30f65dca1faf65aab0d15cea2895fc185582d41f85a9"
  end
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=14.2-STABLE FREEBSD_KERNEL=14.2 FREEBSD_MACHINE=powerpc FREEBSD_MACHINE_ARCH=powerpcspe
    EOS
    bom << resources.map { |r|
  ...
  test do
    resource "testcases" do
      url KsysrootPowerpcspeFreebsd142AT142FreebsdStable.stable.url
      sha256 KsysrootPowerpcspeFreebsd142AT142FreebsdStable.stable.checksum.hexdigest
    end
