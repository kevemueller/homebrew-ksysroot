class KsysrootX8664Freebsd142AT142FreebsdStable < Formula
  desc "Sysroot for x86_64-freebsd14.2@FreeBSD14.2-STABLE"
  ...
  resource "base.txz" do
    url "https://download.freebsd.org/snapshots/amd64/amd64/14.2-STABLE/base.txz"
    version "14.2-STABLE-ksr"
    sha256 "759fad954eb1e4fe6b7f36eba8241e017f9d560bf9b5f0505d891dc45afb3985"
  end
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=14.2-STABLE FREEBSD_KERNEL=14.2 FREEBSD_MACHINE=amd64 FREEBSD_MACHINE_ARCH=amd64
    EOS
    bom << resources.map { |r|
  ...
  test do
    resource "testcases" do
      url KsysrootX8664Freebsd142AT142FreebsdStable.stable.url
      sha256 KsysrootX8664Freebsd142AT142FreebsdStable.stable.checksum.hexdigest
    end
