class KsysrootPowerpcFreebsd142AT142FreebsdStable < Formula
  ...
  resource "base.txz" do
    ...
    version "14.2-STABLE"
    sha256 "edad8bca442aa9a5e03991a59920e998014f754f595ecf49ed5e0baf2b431734"
  end
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=14.2-STABLE FREEBSD_MACHINE=powerpc FREEBSD_MACHINE_ARCH=powerpc
    EOS
    bom << resources.map { |r|
