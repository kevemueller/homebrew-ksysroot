class KsysrootI386LinuxGnu < Formula
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, arm64_sequoia: "e8583bd0681ef5c20a5186bddef03f19ed8602e04bfb2da52d8e1734c98b2dd1"
    sha256 cellar: :any_skip_relocation, ventura:       "33ad65105fb6218cbbb5c621fc56cc8b70663dd1ad1626d2580a574c7251b48c"
    sha256 cellar: :any_skip_relocation, x86_64_linux:  "b2c85e8961d25e26acd336fbb94cdcc6ac3956338a310b202dcdd1b272ee453c"
  end
  ...
  test do
    resource "testcases" do
      url KsysrootI386LinuxGnu.stable.url
      sha256 KsysrootI386LinuxGnu.stable.checksum.hexdigest
    end
