class KsysrootPowerpcspeFreebsd141AT141FreebsdRelease < Formula
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=14.1-RELEASE FREEBSD_KERNEL=14.1 FREEBSD_MACHINE=powerpc FREEBSD_MACHINE_ARCH=powerpcspe
    EOS
    bom << resources.map { |r|
    ...
    mkdir meson_cross
    meson_cross.install prefix/"cross.txt" => "powerpcspe-freebsd14.1"
    meson_cross.install_symlink meson_cross/"powerpcspe-freebsd14.1" => link_triple unless link_triple.empty?
  end
  test do
    ...
    resource("testcases").stage do
      ...
      system Formula["meson"].bin/"meson", "setup", "--native-file=ksysroot",
             "--cross-file=powerpcspe-freebsd14.1", testpath/"build"
