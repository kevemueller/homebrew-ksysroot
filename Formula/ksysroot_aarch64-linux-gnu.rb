class KsysrootAarch64LinuxGnu < Formula
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, arm64_sequoia: "c52e8c267db637702cf325e0236ed354b945e8b504657e801fccf07a0fe25db7"
    sha256 cellar: :any_skip_relocation, ventura:       "6768003e75927dbb6dc487389d58bfbb56e52b771b8334166c3187b7fbee7a7f"
    sha256 cellar: :any_skip_relocation, x86_64_linux:  "984f15579fd44c25585a15b141e15fcb43508193809f2e7567ea461e88f7c679"
  end
  ...
  def install
    ...
    mkdir meson_cross
    meson_cross.install prefix/"cross.txt" => "aarch64-linux6.1-gnu"
    meson_cross.install_symlink meson_cross/"aarch64-linux6.1-gnu" => link_triple unless link_triple.empty?
  end
  test do
    resource "testcases" do
      url KsysrootAarch64LinuxGnu.stable.url
      sha256 KsysrootAarch64LinuxGnu.stable.checksum.hexdigest
    end
