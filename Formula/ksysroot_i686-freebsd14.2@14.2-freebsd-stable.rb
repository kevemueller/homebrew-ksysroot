class KsysrootI686Freebsd142AT142FreebsdStable < Formula
  ...
  resource "base.txz" do
    ...
    sha256 "2a138454035b338a2072b24360e36bfd797d865b333df2599471ea6b1a6869ad"
  end
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=14.2-STABLE FREEBSD_KERNEL=14.2 FREEBSD_MACHINE=i386 FREEBSD_MACHINE_ARCH=i386
    EOS
    bom << resources.map { |r|
