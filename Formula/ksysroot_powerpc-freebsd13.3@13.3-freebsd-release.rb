class KsysrootPowerpcFreebsd133AT133FreebsdRelease < Formula
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=13.3-RELEASE FREEBSD_KERNEL=13.3 FREEBSD_MACHINE=powerpc FREEBSD_MACHINE_ARCH=powerpc
    EOS
    bom << resources.map { |r|
    ...
    mkdir meson_cross
    meson_cross.install prefix/"cross.txt" => "powerpc-freebsd13.3"
    meson_cross.install_symlink meson_cross/"powerpc-freebsd13.3" => link_triple unless link_triple.empty?
  end
  test do
    ...
    resource("testcases").stage do
      ...
      system Formula["meson"].bin/"meson", "setup", "--native-file=ksysroot",
             "--cross-file=powerpc-freebsd13.3", testpath/"build"
