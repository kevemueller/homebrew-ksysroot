class KsysrootPowerpc64Freebsd134AT134FreebsdStable < Formula
  ...
  resource "base.txz" do
    ...
    sha256 "8930692237ffaf033a8d394c693c6bbc0501aa401ea8f65b1c0d5d2c52bdfb23"
  end
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=13.4-STABLE FREEBSD_MACHINE=powerpc FREEBSD_MACHINE_ARCH=powerpc64
    EOS
    bom << resources.map { |r|
