class KsysrootPowerpc64Freebsd134AT134FreebsdStable < Formula
  desc "Sysroot for powerpc64-freebsd13.4@FreeBSD13.4-STABLE"
  ...
  resource "base.txz" do
    url "https://download.freebsd.org/snapshots/powerpc/powerpc64/13.4-STABLE/base.txz"
    version "13.4-STABLE-ksr"
    sha256 "c17e9559f87065247f65c649092fa5befe202603f854cf66fca8a4281b5fc2a0"
  end
  ...
  def install
    ...
    bom = <<~EOS
      ...
      # FREEBSD_VERSION=13.4-STABLE FREEBSD_KERNEL=13.4 FREEBSD_MACHINE=powerpc FREEBSD_MACHINE_ARCH=powerpc64
    EOS
    bom << resources.map { |r|
  ...
  test do
    resource "testcases" do
      url KsysrootPowerpc64Freebsd134AT134FreebsdStable.stable.url
      sha256 KsysrootPowerpc64Freebsd134AT134FreebsdStable.stable.checksum.hexdigest
    end
